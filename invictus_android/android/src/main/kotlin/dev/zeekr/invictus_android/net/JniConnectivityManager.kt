...
internal class JniConnectivityManager {
    internal interface JniNetworkCallback {
    ...
    internal class JniNetworkCallbackImpl : ConnectivityManager.NetworkCallback {
        private val callback: JniNetworkCallback

        constructor(callback: JniNetworkCallback) : super() {
            this.callback = callback
        }

        @RequiresApi(Build.VERSION_CODES.S)
        constructor(callback: JniNetworkCallback, flags: Int) : super(flags) {
            this.callback = callback
        }
