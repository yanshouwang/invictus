...
class InvictusVolumeInfo(val obj: Any) {
    companion object {
        val clazz: Class<*> get() = Class.forName("android.os.storage.VolumeInfo")

        val ACTION_VOLUME_STATE_CHANGED: String
            get() = clazz.getField("ACTION_VOLUME_STATE_CHANGED").get(null) as String
        val EXTRA_VOLUME_ID: String get() = clazz.getField("EXTRA_VOLUME_ID").get(null) as String
    ...
    val stateDescription: Int get() = clazz.getMethod("getStateDescription").invoke(this.obj) as Int
    ...
    val description: String? get() = clazz.getMethod("getDescription").invoke(this.obj) as String?
