...
extension SocketKeepalive$Callback$$Methods on SocketKeepalive$Callback {
  ...
  void onDataReceived() {
    ...
    _onDataReceived(_$$selfRef.pointer, _id_onDataReceived.pointer).check();
  }
  ...
  void onStarted() {
    final _$$selfRef = reference;
    _onStarted(_$$selfRef.pointer, _id_onStarted.pointer).check();
  }
...
extension SocketKeepalive$$Methods on SocketKeepalive {
  ...
  void start(core$_.int i) {
    final _$$selfRef = reference;
    _start(_$$selfRef.pointer, _id_start.pointer, i).check();
  }
