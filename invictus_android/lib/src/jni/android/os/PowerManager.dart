...
import '../../java/time/Duration.dart' as duration$_;

import '../../java/util/concurrent/Executor.dart' as executor$_;

import 'WorkSource.dart' as worksource$_;
...
extension PowerManager$WakeLock$$Methods on PowerManager$WakeLock {
  ...
  void acquire$1(core$_.int j) {
    final _$$selfRef = reference;
    _acquire$1(_$$selfRef.pointer, _id_acquire$1.pointer, j).check();
  }
  ...
  void release$2(core$_.int i) {
    final _$$selfRef = reference;
    _release$2(_$$selfRef.pointer, _id_release$2.pointer, i).check();
  }
...
extension PowerManager$$Methods on PowerManager {
  ...
  /// The returned object must be released after use, by calling the [release] method.
  duration$_.Duration? get batteryDischargePrediction {
    final _$$selfRef = reference;
  ...
  void reboot(jni$_.JString? string) {
    final _$$selfRef = reference;
    final _$string = string?.reference ?? jni$_.jNullReference;
    _reboot(_$$selfRef.pointer, _id_reboot.pointer, _$string.pointer).check();
  }
