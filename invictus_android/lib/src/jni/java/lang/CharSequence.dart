...
import '../util/stream/IntStream.dart' as intstream$_;
...
extension CharSequence$$Methods on CharSequence {
  ...
  /// The returned object must be released after use, by calling the [release] method.
  intstream$_.IntStream? codePoints() {
    final _$$selfRef = reference;
    return _codePoints(
      _$$selfRef.pointer,
...
abstract base mixin class $CharSequence {
  factory $CharSequence({
    ...
    required intstream$_.IntStream? Function() chars,
    required intstream$_.IntStream? Function() codePoints,
...
final class _$CharSequence with $CharSequence {
  ...
  final intstream$_.IntStream? Function() _chars;
  final intstream$_.IntStream? Function() _codePoints;
