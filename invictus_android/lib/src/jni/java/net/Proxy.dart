...
extension type Proxy$Type._(jni$_.JObject _$this) implements enum$_.Enum {
...
extension type Proxy._(jni$_.JObject _$this) implements jni$_.JObject {
  ...
  factory Proxy(
    Proxy$Type? type,
    socketaddress$_.SocketAddress? socketAddress,
  ) {
    final _$$classRef = _class.reference;
...
extension Proxy$$Methods on Proxy {
  ...
  /// The returned object must be released after use, by calling the [release] method.
  socketaddress$_.SocketAddress? address() {
