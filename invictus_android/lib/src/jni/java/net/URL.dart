...
import 'URLStreamHandler.dart' as urlstreamhandler$_;

import 'URLStreamHandlerFactory.dart' as urlstreamhandlerfactory$_;
...
extension type URL._(jni$_.JObject _$this)
  ...
  factory URL.new$2(
    ...
    core$_.int i,
    jni$_.JString? string2,
    urlstreamhandler$_.URLStreamHandler? uRLStreamHandler,
  ) {
    final _$$classRef = _class.reference;
    final _$string = string?.reference ?? jni$_.jNullReference;
    final _$string1 = string1?.reference ?? jni$_.jNullReference;
  ...
  static set uRLStreamHandlerFactory(
    urlstreamhandlerfactory$_.URLStreamHandlerFactory? uRLStreamHandlerFactory,
  ) {
    final _$$classRef = _class.reference;
