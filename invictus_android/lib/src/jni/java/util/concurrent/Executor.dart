...
extension type Executor._(jni$_.JObject _$this) implements jni$_.JObject {
  ...
  static final core$_.Map<core$_.int, $Executor> _$impls = {};
  ...
  static jni$_.Pointer<jni$_.Void> _$invokeMethod(
    ...
    try {
      ...
      if ($d == r'execute(Ljava/lang/Runnable;)V') {
        _$impls[$p]!.execute(($a![0] as runnable$_.Runnable?));
  ...
  factory Executor.implement($Executor $impl) {
    ...
    implementIn($i, $impl);
    return $i.implement<Executor>();
  }
}

extension Executor$$Methods on Executor {
  static final _id_execute = Executor._class.instanceMethodId(
    r'execute',
...
abstract base mixin class $Executor {
  factory $Executor({
    ...
    core$_.bool execute$async,
  }) = _$Executor;

  void execute(runnable$_.Runnable? runnable);
  core$_.bool get execute$async => false;
}
...
final class _$Executor with $Executor {
  ...
  final core$_.bool execute$async;
