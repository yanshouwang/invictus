...
abstract interface class WifiManager {
  factory WifiManager() => WifiManagerChannel.instance.create();
...
abstract base class WifiManagerChannel extends PlatformInterface {
  ...
  static WifiManagerChannel? _instance;

  /// The default instance of [WifiManagerChannel] to use.
  static WifiManagerChannel get instance =>
      ArgumentError.checkNotNull(_instance, 'instance');

  /// Platform-specific implementations should set this with their own
  /// platform-specific class that extends [WifiManagerChannel] when
  /// they register themselves.
  static set instance(WifiManagerChannel instance) {
    PlatformInterface.verifyToken(instance, _token);
    _instance = instance;
  }
